...
/**
 * Aceasta este clasa corespunzatoare procesului Square.
 */
    int n;
    HomeworkWriter fout;
    boolean exista;
 ...
 */
    public Square(int n, HomeworkWriter fout, boolean exista) {
        this.n = n;
        this.fout = fout;
        this.exista = exista;
    }
...
/**
 * 
 * @return int numarul la puterea a 2a
 */
    @Override
    int proces() {
        return n*n;
 ...
 */
    ...
    void display() {
        ...
        if (exista)
            ...
            sir = "Computed";
        fout.println(n + " Square " + proces() + " " + sir);
    }
